...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            <li><a href="{{ url(Auth::user()->role . '/Contoh') }}">Contoh</a></li>
    ...
    <div class="main-content">
        ...
        <header style="display: flex; justify-content:space-between">
            ...
            <div>
                <button class="card-button"><a class="text-decoration-none text-white"
                        href="{{ url('/produk/add') }}">Add Product</a></button>
            </div>
        </header>
        <!-- Produk Grit -->
        <div>
